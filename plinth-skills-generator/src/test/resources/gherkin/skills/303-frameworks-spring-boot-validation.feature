Feature: Validate changes from usage of frameworks Spring Boot validation skill

Background:
  Given the skill "303-frameworks-spring-boot-validation"
  And the folder "examples" has no git changes

@acceptance-test
Scenario: Apply frameworks Spring Boot validation guidance from a concrete Java request
  Given the user request is "Review a Java project and apply frameworks Spring Boot validation guidance"
  And the local generated skill path ".agents/skills/303-frameworks-spring-boot-validation"
  And the folder "examples" has no git changes
  When the skill ".agents/skills/303-frameworks-spring-boot-validation" is applied to the request
