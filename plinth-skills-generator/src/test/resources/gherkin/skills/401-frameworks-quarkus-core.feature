Feature: Validate changes from usage of frameworks Quarkus core skill

Background:
  Given the skill "401-frameworks-quarkus-core"
  And the folder "examples" has no git changes

@acceptance-test
Scenario: Apply frameworks Quarkus core guidance from a concrete Java request
  Given the user request is "Review a Java project and apply frameworks Quarkus core guidance"
  And the local generated skill path ".agents/skills/401-frameworks-quarkus-core"
  And the folder "examples" has no git changes
  When the skill ".agents/skills/401-frameworks-quarkus-core" is applied to the request
