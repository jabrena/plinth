Feature: Validate changes from usage of java testing integration testing skill

Background:
  Given the skill "132-java-testing-integration-testing"
  And the folder "examples" has no git changes

@acceptance-test
Scenario: Apply java testing integration testing guidance from a concrete Java request
  Given the user request is "Review a Java project and apply java testing integration testing guidance"
  And the local generated skill path ".agents/skills/132-java-testing-integration-testing"
  And the folder "examples" has no git changes
  When the skill ".agents/skills/132-java-testing-integration-testing" is applied to the request
