...
Scenario: Generate skills inventory with every skill declared in skills.xml
  ...
  And the inventory template asset path "assets/java-skills-inventory-template.md"
  And the skill inventory source file "plinth-skills-generator/src/main/resources/skills.xml"
  ...
  And the skill reads "assets/java-skills-inventory-template.md"
  And the skill reads "plinth-skills-generator/src/main/resources/skills.xml"
  ...
  And the generated inventory file includes one inventory row for every skill declared in "plinth-skills-generator/src/main/resources/skills.xml"
  ...
  And no skill declared in "plinth-skills-generator/src/main/resources/skills.xml" is missing from "examples/skills/inventory/INVENTORY-SKILLS-JAVA.md"
  And the generated inventory file does not include skill rows absent from "plinth-skills-generator/src/main/resources/skills.xml"
