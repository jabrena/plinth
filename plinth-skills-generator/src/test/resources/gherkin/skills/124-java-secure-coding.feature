Feature: Validate changes from usage of java secure coding skill

Background:
  Given the skill "124-java-secure-coding"
  And the folder "examples" has no git changes

@acceptance-test
Scenario: Apply java secure coding guidance from a concrete Java request
  Given the user request is "Review a Java project and apply java secure coding guidance"
  And the local generated skill path ".agents/skills/124-java-secure-coding"
  And the folder "examples" has no git changes
  When the skill ".agents/skills/124-java-secure-coding" is applied to the request
