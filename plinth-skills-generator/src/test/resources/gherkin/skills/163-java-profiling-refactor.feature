Feature: Validate changes from usage of java profiling refactor skill

Background:
  Given the skill "163-java-profiling-refactor"
  And the folder "examples" has no git changes

@acceptance-test
Scenario: Apply java profiling refactor guidance from a concrete Java request
  Given the user request is "Review a Java project and apply java profiling refactor guidance"
  And the local generated skill path ".agents/skills/163-java-profiling-refactor"
  And the folder "examples" has no git changes
  When the skill ".agents/skills/163-java-profiling-refactor" is applied to the request
