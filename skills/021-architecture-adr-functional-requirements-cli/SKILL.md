...
For detailed guidance, examples, and constraints, see [references/021-architecture-adr-functional-requirements-cli.md](references/021-architecture-adr-functional-requirements-cli.md).
