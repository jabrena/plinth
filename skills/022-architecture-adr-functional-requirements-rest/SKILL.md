...
For detailed guidance, examples, and constraints, see [references/022-architecture-adr-functional-requirements-rest.md](references/022-architecture-adr-functional-requirements-rest.md).
