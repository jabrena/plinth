...
description: Use when you need to write slice tests for Spring Boot applications — including @WebMvcTest, @JdbcTest, @JsonTest, @MockBean, test profiles, and @TestConfiguration for focused layer testing.
license: Apache-2.0
metadata:
...
Apply the following Spring Boot slice testing guidelines when writing tests. Follow the rules, good/bad examples, and best practices described below.
