...
description: Use when you need to configure local testing with spring-boot-docker-compose — including dependency setup, compose service definitions, profiles, integration test setup, service connections, health checks, test data, and performance optimization.
license: Apache-2.0
metadata:
...
Apply the following Spring Boot local testing guidelines when using Docker Compose for local development and testing. Follow the rules, good/bad examples, and best practices described below.
