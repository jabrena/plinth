---
name: 023-architecture-adr-non-functional-requirements
...
For detailed guidance, examples, and constraints, see [references/023-architecture-adr-non-functional-requirements.md](references/023-architecture-adr-non-functional-requirements.md).
