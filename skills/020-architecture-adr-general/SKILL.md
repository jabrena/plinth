---
name: 020-architecture-adr-general
...
For detailed guidance, examples, and constraints, see [references/020-architecture-adr-general.md](references/020-architecture-adr-general.md).
