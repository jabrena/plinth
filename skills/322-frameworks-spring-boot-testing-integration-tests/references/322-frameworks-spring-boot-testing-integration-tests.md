...
Apply the following Java integration testing guidelines when writing integration tests. Follow the rules, good/bad examples, and best practices described below.
