...
8. Write `benchmarks/scenario2/results/<run-id>.json` conforming to [metrics-v1.schema.json](../../metrics-v1.schema.json).
9. Restore `benchmarks/scenario2/demo/` to empty (only `.gitkeep`).
