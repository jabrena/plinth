...
public record FileValidationResult(Path file, List<String> messages, List<ValidationError> errors) {
    ...
    public static FileValidationResult of(
            Path file, ParseSummary summary, List<ValidationError> errors, boolean verbose) {
    ...
    public static FileValidationResult failed(Path file, String message, boolean verbose) {
