...
- [ ] 1.5 Add `skills-generator/src/main/resources/skill-references/832-regulations-usa-nydfs-cybersecurity-sections-summary.xml` with direct official-source links and section mapping in the same style as the `801-804` chapter summary references.
- [ ] 1.6 Add `skills-generator/src/main/resources/skill-references/832-regulations-usa-nydfs-cybersecurity-engineering-examples.xml` with Java-focused examples and output guidance.
- [ ] 1.7 Add `skills-generator/src/main/resources/skill-references/assets/reports/832-usa-nydfs-cybersecurity-engineering-review-report-template.md` with a potential violation or cybersecurity gap table that includes reference area and associated official-source link columns.
...
- [ ] 1.19 Execute the listed `832-regulations-usa-nydfs-cybersecurity` acceptance prompt and verify it passes.
