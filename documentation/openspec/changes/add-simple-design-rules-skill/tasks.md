...
- [x] 1.7 Step 2 behavior change: add `skills-generator/src/main/resources/skill-indexes/053-skill.xml`.
- [x] 1.8 Step 2 behavior change: add `skills-generator/src/main/resources/skill-references/053-design-simple-rules.xml`.
- [x] 1.9 Step 2 behavior change: register skill id `053` with explicit `skillId="053-design-simple-rules"` and reference `053-design-simple-rules` in `skills-generator/src/main/resources/skills.xml`.
...
- [x] 1.12 Add `skills-generator/src/test/resources/gherkin/skills/053-design-simple-rules.feature`.
- [x] 1.13 Add `053-design-simple-rules` to `skills-generator/src/test/resources/gherkin/skills/acceptance-tests-prompts-skills.md`.
...
- [x] 1.17 Execute the listed `053-design-simple-rules` acceptance prompt and verify it passes, or record why it was skipped. Skipped: no repository command-line runner was found for the `execute @skills-generator/src/test/resources/gherkin/skills/053-design-simple-rules.feature` prompt format.
