...
- [ ] 1.11 Add `skills-generator/src/test/resources/gherkin/821-regulations-uk-operational-resilience.feature` with pull-request and direct-to-main acceptance scenarios modeled after `801-804`.
...
- [ ] 1.14 Add `821-regulations-uk-operational-resilience` to `skills-generator/src/test/resources/gherkin/acceptance-tests-prompts-skills.md`.
