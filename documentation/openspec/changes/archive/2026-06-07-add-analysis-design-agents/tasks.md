...
- [x] 2.1 Promote `.cursor/agents/robot-architect.md` into `plinth-skills-generator/src/main/resources/skill-references/assets/agents/robot-architect.md`.
...
- [x] 3.1 Update `plinth-skills-generator/src/main/resources/skill-references/005-agents-installation.xml`.
- [x] 3.2 Update `plinth-skills-generator/src/main/resources/skill-references/assets/java-agents-inventory-template.md`.
