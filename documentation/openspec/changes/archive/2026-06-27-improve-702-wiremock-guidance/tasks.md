...
- [x] 1.4 Update `skills-generator/src/main/resources/skill-references/702-technologies-wiremock.xml` while preserving existing isolation and matching examples.
...
- [x] 1.12 Update `skills-generator/src/main/resources/skill-indexes/702-skill.xml` if workflow or boundary wording needs alignment. No change required; existing index boundary wording remains aligned.
- [x] 1.13 Add `skills-generator/src/test/resources/gherkin/skills/702-technologies-wiremock.feature`.
- [x] 1.14 Add `702-technologies-wiremock` to `skills-generator/src/test/resources/gherkin/skills/acceptance-tests-prompts-skills.md`.
