...
- [x] Add `skills-generator/src/main/resources/system-prompts/701-technologies-openapi.xml` following PML schema and repository conventions for system prompts.
- [x] Add `skills-generator/src/main/resources/skills/701-skill.xml` with `id="701-technologies-openapi"` aligned to the system prompt scope and triggers.
