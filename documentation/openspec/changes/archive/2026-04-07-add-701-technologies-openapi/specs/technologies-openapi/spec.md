...
New sources for **701** MUST be registered in both `skill-inventory.json` and `system-prompt-inventory.json`, and the `plinth-skills-generator` module MUST build successfully after the change.
