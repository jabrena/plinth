...
- `plinth-skills-generator/src/main/resources/skill-indexes/808-skill.xml` defines metadata, title, goal, constraints, triggers, and workflow steps.
- `plinth-skills-generator/src/main/resources/skill-references/808-regulations-eu-digital-markets-act.xml` provides detailed examples and output guidance.
