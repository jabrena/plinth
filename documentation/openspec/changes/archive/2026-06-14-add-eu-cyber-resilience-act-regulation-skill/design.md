...
- `plinth-skills-generator/src/main/resources/skill-indexes/805-skill.xml` defines metadata, title, goal, constraints, triggers, and workflow steps.
- `plinth-skills-generator/src/main/resources/skill-references/805-regulations-eu-cyber-resilience-act.xml` provides detailed examples and output guidance.
