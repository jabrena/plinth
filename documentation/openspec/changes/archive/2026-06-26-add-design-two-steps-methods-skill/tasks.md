...
- [x] 1.6 Add `plinth-skills-generator/src/main/resources/skill-indexes/051-skill.xml`.
- [x] 1.7 Add `plinth-skills-generator/src/main/resources/skill-references/051-design-two-steps-methods.xml`.
- [x] 1.8 Register skill id `051` with explicit `skillId="051-design-two-steps-methods"` and reference `051-design-two-steps-methods` in `plinth-skills-generator/src/main/resources/skills.xml`.
...
- [x] 1.11 Add `plinth-skills-generator/src/test/resources/gherkin/skills/051-design-two-steps-methods.feature` with the acceptance scenario from issue #877.
- [x] 1.12 Add the matching `execute @plinth-skills-generator/src/test/resources/gherkin/skills/051-design-two-steps-methods.feature` prompt to `plinth-skills-generator/src/test/resources/gherkin/skills/acceptance-tests-prompts-skills.md`.
