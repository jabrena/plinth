...
- [x] 1.1 Add command-focused assertions under `plinth-skills-generator/src/test/java/info/jab/pml/` for the eight new command filenames.
...
- [x] 2.1 Add `create-issue.md`, `create-worktree.md`, `explore-design.md`, `create-adr.md`, `create-diagram.md`, `create-plan.md`, `create-spec.md`, and `review-alignment.md` under `plinth-skills-generator/src/main/resources/skill-references/assets/commands/`.
...
- [x] 3.1 Update `plinth-skills-generator/src/main/resources/skill-references/004-commands-installation.xml` with the complete command bundle.
- [x] 3.2 Update `plinth-skills-generator/src/main/resources/skill-references/assets/java-commands-inventory-template.md`.
- [x] 3.3 Validate `004-commands-installation.xml` with `xmllint`.

## 4. Change Verification

- [x] 4.1 Run command-focused generator tests.
- [x] 4.2 Run `./mvnw clean verify -pl plinth-skills-generator`.
