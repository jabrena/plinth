...
- [x] 1.4 Keep `plinth-skills-generator/src/main/resources/skill-references/316-frameworks-spring-mongodb-migrations-mongock.xml` focused on Spring Boot framework integration.
- [x] 1.5 Keep `plinth-skills-generator/src/main/resources/skill-references/416-frameworks-quarkus-mongodb-migrations-mongock.xml` focused on Quarkus framework integration.
- [x] 1.6 Keep `plinth-skills-generator/src/main/resources/skill-references/516-frameworks-micronaut-mongodb-migrations-mongock.xml` focused on Micronaut framework integration.
...
- [x] 1.11 Register supplemental Mongock reference files in `plinth-skills-generator/src/main/resources/skills.xml`.
...
- [x] 1.14 Ensure `plinth-skills-generator/src/test/resources/gherkin/skills/acceptance-tests-prompts-skills.md` lists prompts for every changed Mongock skill.
...
- [ ] 1.18 Check `plinth-skills-generator/src/test/resources/gherkin/skills/acceptance-tests-prompts-skills.md` and run only listed prompts for changed Mongock skills, if applicable.
- [x] 1.19 Run `./mvnw clean verify -pl plinth-skills-generator`.
