...
- [x] 5.5 Check `skills-generator/src/test/resources/gherkin/skills/acceptance-tests-prompts-skills.md`; execute only a listed `033-architecture-diagrams` prompt if one exists after implementation changes.
