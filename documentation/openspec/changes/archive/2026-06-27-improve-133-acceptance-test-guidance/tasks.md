...
- [x] 1.4 Update `plinth-skills-generator/src/main/resources/skill-references/133-java-testing-acceptance-tests.xml` to preserve the single-reference workflow.
...
- [x] 1.12 Update `plinth-skills-generator/src/main/resources/skill-indexes/133-skill.xml` if workflow or precondition wording needs alignment.
...
- [x] 1.14 Add `plinth-skills-generator/src/test/resources/gherkin/skills/133-java-testing-acceptance-tests.feature` with framework-agnostic generation and invalid-framework routing scenarios.
- [x] 1.15 Add `133-java-testing-acceptance-tests` to `plinth-skills-generator/src/test/resources/gherkin/skills/acceptance-tests-prompts-skills.md`.
