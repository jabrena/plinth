...
- [x] Add `skills-generator/src/main/resources/skill-references/702-technologies-wiremock.xml` following PML schema and repository conventions for system prompts.
- [x] Add `skills-generator/src/main/resources/skill-indexes/702-skill.xml` with `id="702-technologies-wiremock"` aligned to the system prompt scope and triggers.
