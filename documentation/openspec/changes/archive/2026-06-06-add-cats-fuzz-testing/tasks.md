...
- [x] Create the new skill at `plinth-skills-generator/src/main/resources/skill-indexes/134-skill.xml` and register it in the skill inventory.
...
- [x] Regenerate skills (`./mvnw clean install -pl plinth-skills-generator`) and confirm generated artifacts are updated.
