...
- Update and review `plinth-skills-generator/src/test/resources/gherkin/skills/801-regulations-eu-ai-act.feature`, `802-regulations-dora.feature`, and `803-regulations-gdpr.feature`.
- If regenerated local skill output changes for skills listed in `plinth-skills-generator/src/test/resources/gherkin/skills/acceptance-tests-prompts-skills.md`, execute the listed prompt for each changed skill and verify acceptance passes.
