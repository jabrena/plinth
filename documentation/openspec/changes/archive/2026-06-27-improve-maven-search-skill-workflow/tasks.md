...
- [x] 1.2 Review `plinth-skills-generator/src/main/resources/skill-indexes/114-skill.xml` and `plinth-skills-generator/src/main/resources/skill-references/114-java-maven-search.xml`.
...
- [x] 1.13 Check `plinth-skills-generator/src/test/resources/gherkin/skills/acceptance-tests-prompts-skills.md` for a `114-java-maven-search` acceptance prompt.
- [x] 1.14 Execute only the listed `114-java-maven-search` acceptance prompt when the prompt exists and generated local output changes; otherwise record the skipped prompt reason.
  Skipped `execute @plinth-skills-generator/src/test/resources/gherkin/skills/114-java-maven-search.feature`: no local `execute @...feature` acceptance-prompt runner or command is available in this environment; generated local skill output and the listed Gherkin scenarios were inspected.
- [x] 1.15 Run focused `plinth-skills-generator` verification for the changed XML and generated output.
