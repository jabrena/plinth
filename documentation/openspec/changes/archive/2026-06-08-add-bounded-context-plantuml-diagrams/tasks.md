...
- [x] 2.1 Update `plinth-skills-generator/src/main/resources/skill-indexes/033-skill.xml` metadata, description, goal text, trigger list, and selected-reference mapping to include bounded-context diagrams.
- [x] 2.2 Update `plinth-skills-generator/src/main/resources/skill-references/assets/questions/033-architecture-diagrams-questions.xml` so bounded-context diagrams are selectable from the main diagram-family question.
...
- [x] 3.1 Add a focused bounded-context reference XML file under `plinth-skills-generator/src/main/resources/skill-references/`.
...
- [x] 4.1 Register the bounded-context reference for skill `033` in `plinth-skills-generator/src/main/resources/skills.xml`.
