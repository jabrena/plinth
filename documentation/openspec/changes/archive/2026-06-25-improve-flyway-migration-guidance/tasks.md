...
- [x] 1.4 Update `plinth-skills-generator/src/main/resources/skill-references/313-frameworks-spring-db-migrations-flyway.xml` with Flyway antipattern and Parallel Change technique guidance.
- [x] 1.5 Update `plinth-skills-generator/src/main/resources/skill-references/413-frameworks-quarkus-db-migrations-flyway.xml` with Flyway antipattern and Parallel Change technique guidance.
- [x] 1.6 Update `plinth-skills-generator/src/main/resources/skill-references/513-frameworks-micronaut-db-migrations-flyway.xml` with Flyway antipattern and Parallel Change technique guidance.
...
- [x] 1.11 Register the new Flyway references in `plinth-skills-generator/src/main/resources/skills.xml`.
...
- [x] 1.16 Check `plinth-skills-generator/src/test/resources/gherkin/skills/acceptance-tests-prompts-skills.md` and run only listed prompts for changed Flyway skills, if any.
...
- [x] 1.20 Register the Flyway acceptance prompts in `plinth-skills-generator/src/test/resources/gherkin/skills/acceptance-tests-prompts-skills.md`.
- [x] 1.21 Re-run `./mvnw clean verify -pl plinth-skills-generator`.
