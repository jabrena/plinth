...
- [x] 1.4 Update `plinth-skills-generator/src/main/resources/skill-references/701-technologies-openapi.xml` while preserving existing metadata and operation examples.
...
- [x] 1.11 Update `plinth-skills-generator/src/main/resources/skill-indexes/701-skill.xml` if workflow or boundary wording needs alignment. No change required; existing index boundary wording remains aligned.
- [x] 1.12 Add `plinth-skills-generator/src/test/resources/gherkin/skills/701-technologies-openapi.feature`.
- [x] 1.13 Add `701-technologies-openapi` to `plinth-skills-generator/src/test/resources/gherkin/skills/acceptance-tests-prompts-skills.md`.
