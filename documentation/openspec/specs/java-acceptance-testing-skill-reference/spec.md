# java-acceptance-testing-skill-reference Specification

## Purpose
TBD - created by archiving change improve-133-acceptance-test-guidance. Update Purpose after archive.
## Requirements
