# java-maven-dependencies-javamoney-guidance Specification

## Purpose
TBD - created by archiving change add-javamoney-guidance-to-maven-dependencies-skill. Update Purpose after archive.
## Requirements
