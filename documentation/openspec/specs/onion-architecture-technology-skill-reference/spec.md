# onion-architecture-technology-skill-reference Specification

## Purpose
Define the requirements for the framework-agnostic Onion architecture technology skill, including boundary review, dependency direction, optional architecture tests, and source/generated-output ownership.
## Requirements
