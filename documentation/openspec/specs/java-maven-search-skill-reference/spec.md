# java-maven-search-skill-reference Specification

## Purpose
Define the expected behavior for the `114-java-maven-search` skill as a router between project-local Maven version update analysis and explicit Maven Central artifact discovery.
