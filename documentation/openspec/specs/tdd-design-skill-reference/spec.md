# tdd-design-skill-reference Specification

## Purpose
Define the generated `054-design-tdd` skill so Java implementation guidance can apply Test-Driven Development with explicit red-green-refactor sequencing, test-list management, generator registration, and acceptance coverage.
