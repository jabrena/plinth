...
- **Cursor CLI:** Pretty interesting alternative from Cursor with the new product Cursor CLI (cursor-agent) but the behaviour is not 100% the same than Cursor IDE.
