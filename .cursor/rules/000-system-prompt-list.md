...
| [324-frameworks-spring-boot-testing-e2e-local-tests](.cursor/rules/324-frameworks-spring-boot-testing-e2e-local-tests.md) | Configure E2E local testing with spring-boot-docker-compose — compose services, profiles, integration test setup, health checks | **User Prompt:** `Set up E2E local testing with Docker Compose using @324-frameworks-spring-boot-testing-e2e-local-tests` **Note:** Add in the context the project. | E2E local testing with Docker Compose. |
