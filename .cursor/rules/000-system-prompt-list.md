...
| [031-architecture-adr-functional-requirements-cli](.cursor/rules/031-architecture-adr-functional-requirements-cli.md) | Create ADRs for CLI development — document architecture, functional requirements, and technical decisions for command-line tools | **Interactive User Prompt:** `Generate an ADR for CLI development with @031-architecture-adr-functional-requirements-cli` **Note:** Add in the context the CLI project. Conversational discovery; asks one or two questions at a time. | CLI-focused ADR generation. |
| [032-architecture-adr-functional-requirements-rest](.cursor/rules/032-architecture-adr-functional-requirements-rest.md) | Create ADRs for REST API development — document architecture, functional requirements, and technical decisions for APIs | **Interactive User Prompt:** `Generate an ADR for REST API development with @032-architecture-adr-functional-requirements-rest` **Note:** Add in the context the API project. Conversational discovery; asks one or two questions at a time. | REST/HTTP API-focused ADR generation. |
| [033-architecture-adr-non-functional-requirements](.cursor/rules/033-architecture-adr-non-functional-requirements.md) | Create ADRs for non-functional requirements — document quality attributes, NFR decisions, security/performance/scalability using ISO/IEC 25010:2023 | **Interactive User Prompt:** `Generate an ADR for non-functional requirements with @033-architecture-adr-non-functional-requirements` **Note:** Add in the context the project. Skips irrelevant quality characteristics; dives deeper where there is uncertainty. | NFR-focused ADR generation. |
| [034-architecture-diagrams](.cursor/rules/034-architecture-diagrams.md) | Generate Java project diagrams including UML sequence, class, state-machine diagrams and C4 model diagrams using a modular step-based approach | **Interactive User Prompt:** `Generate diagrams about the project with the cursor rule @034-architecture-diagrams` **User Prompt:** `Create UML class diagrams with @034-architecture-diagrams without any question` (Example) **Note:** Add in the context the folder to generate the diagrams. The rule will analyze the codebase and ask for user preferences before generating anything. Ensures project validation with Maven before proceeding. | Focused on diagram generation only. I recommend to run the JBang tool `jbang puml-to-png@jabrena --watch .` in order to generate diagrams in PNG format on the fly |
...
| Activity | Description | Prompt | Notes |
|----|----|----|----|
| [170-java-documentation](.cursor/rules/170-java-documentation.md) | Generate Java project documentation including README.md, package-info.java files, and Javadoc using a modular step-based approach | **Interactive User Prompt:** `Generate technical documentation about the project with the cursor rule @170-java-documentation` **User Prompt:** `Generate README.md with @170-java-documentation without any question` (Example) **Note:** Add in the context the folder to generate the documentation. The rule will analyze existing documentation and ask for user preferences before generating anything. Ensures project validation with Maven before proceeding. | Focused on documentation generation only. For diagrams, use @034-architecture-diagrams |
...
| [304-frameworks-spring-data-jdbc](.cursor/rules/304-frameworks-spring-data-jdbc.md) | Apply Spring Data JDBC with Java records — entity design, repository pattern, immutable updates, aggregate relationships, custom queries | **User Prompt:** `Improve the data access layer in context using @304-frameworks-spring-data-jdbc` **Note:** Add in the context the entities, repositories, or project. | Spring Data JDBC with records. |
| [311-frameworks-spring-boot-slice-testing](.cursor/rules/311-frameworks-spring-boot-slice-testing.md) | Write slice tests for Spring Boot — @WebMvcTest, @JdbcTest, @JsonTest, @MockBean, test profiles | **User Prompt:** `Add or improve slice tests in context using @311-frameworks-spring-boot-slice-testing` **Note:** Add in the context the classes to test or test classes. | Focused layer testing. |
| [312-frameworks-spring-boot-integration-testing](.cursor/rules/312-frameworks-spring-boot-integration-testing.md) | Write integration tests for Spring Boot — Testcontainers, TestRestTemplate, data management, test structure | **User Prompt:** `Add or improve integration tests in context using @312-frameworks-spring-boot-integration-testing` **Note:** Add in the context the project or test classes. | Integration testing guidelines. |
| [313-frameworks-spring-boot-local-testing](.cursor/rules/313-frameworks-spring-boot-local-testing.md) | Configure local testing with spring-boot-docker-compose — compose services, profiles, integration test setup, health checks | **User Prompt:** `Set up local testing with Docker Compose using @313-frameworks-spring-boot-local-testing` **Note:** Add in the context the project. | Local testing with Docker Compose. |
