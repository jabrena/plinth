...
7. Apply Java design skills in order when the plan needs design detail: object-oriented responsibilities, type design, then design-pattern selection only for a demonstrated problem.
8. Define the technical approach, affected areas, ordered tasks, risks, and verification.
9. Record source links and any assumptions or unresolved blockers.
