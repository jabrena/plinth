...
- **[@robot-micronaut-coder](robot-micronaut-coder.md):** Micronaut implementation (`@Controller`, programmatic JDBC, Micronaut Data, `Micronaut.run`, CDI-style beans, Micronaut tests — `@501`, `@502`, `@511`, `@512`, `@521`–`@523`). Use when **Framework identification** yields **Micronaut** as the application framework.
