...
- Open source-status questions:
  - Has legal/compliance confirmed current Digital Omnibus legislative status for direct-to-main delivery controls?
  - Which proposed changes, if any, are approved for adoption in incident, privacy, data, AI, or cybersecurity workflows?
  - Can any direct-to-main release gate, incident handoff, privacy evidence, or report-template field be simplified without weakening existing controls?
...
- NIS2 impact signals: The reviewed system includes direct-to-main delivery, cloud-hosted production services, provider dependencies, incident evidence, Kafka contracts, and database migrations; NIS2 applicability is not established by reviewed evidence.
...
- Existing controls that must remain unchanged: Main-branch protection or equivalent review controls, GDPR privacy and breach controls, NIS2 cybersecurity incident controls, DORA resilience controls where applicable, AI Act controls where applicable, data-governance controls, release gates, and evidence retention.
- Open applicability or interpretation questions: Legislative status, affected regulation applicability, direct-to-main release approval, incident-reporting consolidation, data-rights workflow changes, and whether any report-template simplification can be adopted.

## 4. Potential Impact Or Non-Compliance Mapping

This section is not a legal finding. It lists concrete Digital Omnibus proposal-stage impact signals and engineering update candidates from the reviewed direct-to-main evidence. No violation is confirmed by this engineering review.
...
| Direct-to-main release could adopt simplification without review | Change control / regulation-specific compatibility | https://digital-strategy.ec.europa.eu/en/policies/digital-rulebook | Engineers commit directly to `main`; the feature modifies order database structure and Kafka event data | Potential gap | Platform / security / compliance / executive accountability | Require protected-main or equivalent approval evidence before adopting Digital Omnibus-driven workflow or control changes |
...
| Existing regulation-skill conclusion could be rewritten without owner decision | AI Act / GDPR / DORA / NIS2 / Data Act | https://digital-strategy.ec.europa.eu/en/policies/digital-rulebook | No owner decision exists to change GDPR, NIS2, DORA, AI Act, or data-governance controls for this direct-to-main release | Potential gap | Legal / compliance / security / privacy / risk | Preserve existing regulation-specific controls and add compatibility check before report templates or questionnaires are updated |
...
- Evidence inventory updates: Update data inventory, Kafka event inventory, report-template inventory, incident runbook inventory, owner inventory, branch protection inventory, and release evidence inventory.
- Change-control impact records: Direct-to-main delivery must not be used to adopt proposal-stage simplification without source-status evidence, owner approval, and compatibility checks.
- Questionnaire update candidates: Add candidate questions for Digital Omnibus source status, owner approval, affected-regulation mapping, direct-to-main exception approval, and existing-skill compatibility.
...
- Ambiguity escalation: Escalate proposal-stage ambiguity, missing source status, missing owner decisions, direct-to-main exceptions, and any proposed control relaxation.
...
- Release gate or change-control evidence: Direct commits to `main` and main branch CI are described; explicit pre-merge review, protected-main approval, direct-to-main exception, or Digital Omnibus-specific change-control evidence is not present.
- Owner approval record: Not present.

## 7. Residual Risks

- Residual risk: Direct-to-main delivery may allow proposal-stage simplification assumptions to change privacy, incident, cybersecurity, data-governance, or release controls without independent review.
- Impact: Premature control relaxation, unresolved legal status, incomplete breach or incident handoff, weak change-control evidence, and unsupported audit evidence.
- Likelihood: Medium, because the reviewed delivery model commits every change directly to `main`.
- Mitigation: Require protected-main or equivalent approval, source-status record, affected-regulation mapping, owner approvals, and compatibility checks with regulation-specific skills.
- Owner: Platform owner, legal/compliance owner, privacy owner, security owner, data-governance owner, resilience owner, and executive accountability owner.
...
- Acceptance decision: Required before committing to `main` and before production deployment.
- Review date: During direct-to-main approval and release readiness.

## 8. Adoption Or Release Decision

- Decision: Blocked for production until direct-to-main delivery is supplemented with Digital Omnibus source-status evidence, affected-regulation mapping, owner handoffs, and equivalent review controls.
- Conditions:
  - Protected-main or equivalent approval control is enforced before adopting Digital Omnibus-related workflow changes.
...
- Blockers:
  ...
  - Missing named legal/compliance, privacy, security, data-governance, resilience, platform, and AI governance owners.
...
- Required approvals: Service owner, tech lead, legal/compliance owner, privacy owner, security owner, data-governance owner, resilience owner, platform owner, executive accountability owner, and AI governance owner for AI timeline assumptions.
...
- Rollback or reversion path: Revert any direct-to-main questionnaire, report-template, incident-workflow, data-rights, or release-gate change that was based on unapproved Digital Omnibus assumptions.

## 9. Action Plan

| Priority | Action | Owner | Due date | Evidence expected | Status |
| -------- | ------ | ----- | -------- | ----------------- | ------ |
| High | Add protected-main or equivalent auditable review control before any Digital Omnibus-driven workflow or control change | Platform owner / security owner | Before production deployment | Branch protection, approval, or exception evidence | Open |
| High | Create Digital Omnibus source-status record with official links, observed status, review date, and legal/compliance owner | Legal/compliance owner | Before direct-to-main approval | Source-status evidence linked to release | Open |
| High | Add affected-regulation map for GDPR/ePrivacy, NIS2, DORA watch items, Data Act/data governance, cybersecurity reporting, and AI Act watch item | Compliance / architecture owner | Before direct-to-main approval | Mapping table linked to release | Open |
...
| High | Add privacy-safe logging, data inventory, retention, and data-rights workflow impact evidence for delivery instructions | Privacy / data-governance owner | Before release approval | Tests, inventory update, workflow impact note | Open |
...
- Items requiring legal interpretation: Applicability to ecommerce checkout, direct-to-main controls, incident-reporting consolidation, privacy workflow changes, and data-governance changes.
...
- Items requiring security or resilience review: Direct-to-main release controls, incident workflow consolidation, provider handoffs, alert evidence, and release gates.
...
- Items requiring architecture decision: Direct-to-main release policy, Kafka contract compatibility, database migration rollout, data propagation boundaries, and source-status release gate.
- Items requiring product or business acceptance: Any release delay from unresolved owner approvals, direct-to-main review requirements, or data-rights workflow changes.
- Next review trigger: Direct-to-main approval request, production deployment request, Digital Omnibus source-status change, incident-workflow update, data-rights workflow update, report-template change, or regulation-specific skill update.
