...
| Incorrect, incomplete, or unsupported regulatory information | Penalties / Articles 99-101 | [Chapter XII](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=OJ:L_202401689#cpt_XII) | EU territorial scope, model/provider details, GenAI data flows, AI-origin audit evidence, and owner approvals are unknown or incomplete in the reviewed materials. | Potential gap if represented as compliant without qualification | Legal / compliance / risk owner | Keep unknowns explicit, avoid claiming compliance, and require qualified review before production expansion or autonomous tooling. |
