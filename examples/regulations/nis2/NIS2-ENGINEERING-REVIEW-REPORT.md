...
| Production side-effect risk from automated deployment | Change control / release governance | [Chapter IV](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:32022L2555#cpt_IV) | Pipeline automatically deploys through environments and production after checks pass | Potential gap | Platform / security / business owner | Gate production release on cybersecurity evidence, provider review, continuity evidence, and owner approval for the delivery-instructions change |
