...
The purpose of this report is to increase awareness of proposal-stage Digital Omnibus impacts and create engineering evidence for qualified review. The response produced from this template does not represent legal advice, a legal opinion, a final regulatory determination, or approval to relax regulation-specific controls.
...
- Proposal-stage assumptions:
- Source-status owner:
- Open source-status questions:

## 3. Affected-Regulation Scope

- AI Act impact signals:
- GDPR or ePrivacy impact signals:
- DORA impact signals:
- NIS2 impact signals:
- Data Act or data-governance impact signals:
- Cybersecurity reporting impact signals:
- Platform-to-business or digital-platform impact signals:
- Existing regulation skills reviewed:
- Existing controls that must remain unchanged:
- Open applicability or interpretation questions:
...
- Affected-regulation mapping:
- Evidence inventory updates:
- Change-control impact records:
- Questionnaire update candidates:
- Report-template update candidates:
- Incident-reporting workflow consolidation:
- Data-rights workflow impact review:
- AI governance timeline review:
- Existing regulation skill compatibility:
...
- Incident runbook:
- Breach or cybersecurity reporting workflow:
- Data-rights workflow:
- AI governance roadmap:
- Provider or supply-chain review:
- Release gate or change-control evidence:
...
- Environments or workflows approved:
- Rollback or reversion path:
...
- Items requiring legislative-status assessment:
- Items requiring legal interpretation:
- Items requiring compliance review:
- Items requiring privacy review:
- Items requiring security or resilience review:
- Items requiring data-governance review:
- Items requiring AI governance review:
