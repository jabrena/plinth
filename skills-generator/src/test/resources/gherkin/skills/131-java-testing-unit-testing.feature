Feature: Validate changes from usage of java testing unit testing skill

Background:
  Given the skill "131-java-testing-unit-testing"
  And the folder "examples" has no git changes

@acceptance-test
Scenario: Apply java testing unit testing guidance from a concrete Java request
  Given the user request is "Review a Java project and apply java testing unit testing guidance"
  And the local generated skill path ".agents/skills/131-java-testing-unit-testing"
  And the folder "examples" has no git changes
  When the skill ".agents/skills/131-java-testing-unit-testing" is applied to the request
