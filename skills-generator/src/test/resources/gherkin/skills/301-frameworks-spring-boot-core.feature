Feature: Validate changes from usage of frameworks Spring Boot core skill

Background:
  Given the skill "301-frameworks-spring-boot-core"
  And the folder "examples" has no git changes

@acceptance-test
Scenario: Apply frameworks Spring Boot core guidance from a concrete Java request
  Given the user request is "Review a Java project and apply frameworks Spring Boot core guidance"
  And the local generated skill path ".agents/skills/301-frameworks-spring-boot-core"
  And the folder "examples" has no git changes
  When the skill ".agents/skills/301-frameworks-spring-boot-core" is applied to the request
