...
Scenario: Review a Java investment-service change with MiFID II controls
  ...
  And the skill scopes possible investment-service signals, investment-activity signals, financial instruments, client categories, order flows, advisory workflows, portfolio-management workflows, trading venues, market data flows, system owners, product owners, compliance owners, risk owners, operations owners, trading owners, security owners, environments, APIs, data stores, event streams, algorithmic trading controls, reporting paths, monitoring paths, and release paths
  ...
  And the skill recommends engineering controls for investment-service scope inventory, client classification, suitability and appropriateness evidence, product governance, order lifecycle audit, best-execution metrics, algorithm inventory, pre-trade controls, kill switches, timestamp precision, record retention, evidence-safe logging, access control, observability, change control, documentation, database migration approval, Kafka schema compatibility, and compliance evidence handoff
