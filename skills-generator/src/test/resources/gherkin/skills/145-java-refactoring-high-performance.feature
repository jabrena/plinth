Feature: Validate changes from usage of java refactoring high performance skill

Background:
  Given the skill "145-java-refactoring-high-performance"
  And the folder "examples" has no git changes

@acceptance-test
Scenario: Apply java refactoring high performance guidance from a concrete Java request
  Given the user request is "Review a Java project and apply java refactoring high performance guidance"
  And the local generated skill path ".agents/skills/145-java-refactoring-high-performance"
  And the folder "examples" has no git changes
  When the skill ".agents/skills/145-java-refactoring-high-performance" is applied to the request
