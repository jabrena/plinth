Feature: Validate changes from usage of java object oriented design skill

Background:
  Given the skill "121-java-object-oriented-design"
  And the folder "examples" has no git changes

@acceptance-test
Scenario: Apply java object oriented design guidance from a concrete Java request
  Given the user request is "Review a Java project and apply java object oriented design guidance"
  And the local generated skill path ".agents/skills/121-java-object-oriented-design"
  And the folder "examples" has no git changes
  When the skill ".agents/skills/121-java-object-oriented-design" is applied to the request
