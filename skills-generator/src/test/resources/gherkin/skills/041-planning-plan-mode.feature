...
@acceptance-test
Scenario: Apply planning plan mode guidance from a concrete Java request
  Given the user request is "Review a Java project and apply planning plan mode guidance"
  And the local generated skill path ".agents/skills/041-planning-plan-mode"
  And the folder "examples" has no git changes
  When the skill ".agents/skills/041-planning-plan-mode" is applied to the request
