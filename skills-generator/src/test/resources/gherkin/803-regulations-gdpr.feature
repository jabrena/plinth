...
Scenario: Review a Java personal-data service with GDPR privacy controls
  ...
  And the skill reports conclusions and actions with personal-data scope, evidence reviewed, gaps, required escalations, release decision, residual risks, owners, and due dates
