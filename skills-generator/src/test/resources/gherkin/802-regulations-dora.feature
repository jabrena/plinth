...
Scenario: Review a Java financial service with DORA operational resilience controls
  ...
  And the skill reports conclusions and actions with operational scope, evidence reviewed, gaps, required escalations, release decision, residual risks, owners, and due dates
