...
Scenario: Generate a deployment diagram from a system description file
  ...
  And the user request is "Generate a UML Deployment Diagram from examples/diagrams/deployment/system-example-cicd-pr-model.md"
  ...
  And the skill uses "examples/diagrams/deployment/system-example-cicd-pr-model.md" as the deployment system description input
