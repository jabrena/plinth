...
Scenario: Create an isolated branch and linked worktree
  ...
  And the command always creates a fresh branch and linked worktree for the requested work
  And the command derives the next unused branch name or worktree path instead of reusing existing worktree directories or existing branches
